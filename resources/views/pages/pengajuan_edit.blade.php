    ...
    <section class="overflow-y-auto">
        ...
        <form method="POST" action="{{ route('update.pengajuan',$data->id) }}" enctype="multipart/form-data" class="max-w-3xl mx-auto mt-10 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nim" value="{{$data->nim}}" placeholder="Nomor Induk Siswa/Mahasiswa" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
            </div>
