...
@section('dashboard')
    <section class="overflow-y-auto">
        <div class="text-center">
            <p class=" font-[rubik] font-[700] md:text-2xl">Buat Pengajuan Magang Baru</p>
            <p class="font-[rubik] md:text-sm">Pastikan Anda melengkapi semua informasi yang ada dibawah ini</p>
        </div>
        <form method="POST" action="{{ route('store.pengajuan') }}" enctype="multipart/form-data" class="max-w-3xl mx-auto mt-10 space-y-6">
            @csrf
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap <span class="text-red-700">*</span></label>
                <input type="text" name="name" placeholder="Masukan Nama Lengkap" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
            </div>
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" name="email" placeholder="Masukan Email Aktif" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nomor WhatsApp <span class="text-red-700">*</span></label>
                    <input type="number" name="phone" placeholder="Contoh: 08123456789" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="school" placeholder="Masukan Nama Sekolah/Universitas" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="jurusan" placeholder="Masukan Nama Jurusan" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
                </div>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Bidang Peminatan Magang<span class="text-red-700">*</span></label>
                <input type="text" name="spesialitation" placeholder="Contoh: Electrical Maintenance" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Waktu Mulai Magang <span class="text-red-700">*</span></label>
                    <input type="date" name="start_date" class="w-full text-sm border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Waktu Selesai Magang <span class="text-red-700">*</span></label>
                    <input type="date" name="end_date" class="w-full text-sm border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-sm placeholder:pl-2" required>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <div x-data="{ fileName: null }" class="space-y-1">
